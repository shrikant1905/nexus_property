...
import { financeDashboardData } from '../../../data/dashboard';
...
export default function FinanceDashboard() {
  ...
  const { stats, revenueByProperty, expensesByCategory } = financeDashboardData;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">Financial health and reconciliation overview</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white bg-[#009bf2] hover:bg-[#008be0] transition-colors cursor-pointer">
            Generate Report
          </button>
        </div>
      </div>
