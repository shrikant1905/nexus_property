...
import MaintenanceKPIDashboardPage from '../pages/maintenance/MaintenanceKPIDashboardPage';
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route element={<RoleRoute allowedRoles={['office-admin']} />}>
          <Route path="/admin" element={<MaintenanceLayout />}>
            ...
            <Route path="kpi-dashboard" element={<MaintenanceKPIDashboardPage />} />
            <Route path="inventory" element={<MaintenanceInventoryPage />} />
        ...
        <Route element={<RoleRoute allowedRoles={['maintenance-staff', 'office-admin']} />}>
        ...
        {/* Dedicated Office Team Portal Routes */}
        <Route element={<RoleRoute allowedRoles={['office-team', 'office-admin']} />}>
          <Route path="/office" element={<MaintenanceLayout />}>
            <Route index element={<Navigate to="dashboard" replace />} />
            <Route path="dashboard" element={<MaintenanceDashboardPage />} />
