                  ...
                  <div className="flex items-center justify-between gap-3 border-b border-slate-100 pb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-sky-50 border border-sky-200 overflow-hidden flex items-center justify-center font-black flex-shrink-0 text-sky-700">
                        {t.documentUrl ? (
                          <img
                            src={t.documentUrl.startsWith('/uploads') ? `https://nexusfmsbackednshrikant-production.up.railway.app${t.documentUrl}` : t.documentUrl}
                            alt={t.name}
            ...
            <div className="relative group cursor-pointer" onClick={() => document.getElementById('resident-avatar-input').click()}>
              <div className="w-20 h-20 rounded-full border-2 border-slate-200 overflow-hidden bg-slate-100 flex items-center justify-center relative shadow-sm group-hover:border-[#00204a] transition-all">
                {documentFile ? (
                  ...
                  <img
                    src={form.documentUrl.startsWith('/uploads') ? `https://nexusfmsbackednshrikant-production.up.railway.app${form.documentUrl}` : form.documentUrl}
                    alt="Resident Avatar"
                    className="w-full h-full object-cover"
                  />
                ) : (
            ...
            <div className="flex justify-center pb-1">
              <div className="w-16 h-16 rounded-full border-2 border-slate-200 overflow-hidden bg-sky-50 flex items-center justify-center shadow-sm">
                {viewingTenant.documentUrl ? (
                  <img
                    src={viewingTenant.documentUrl.startsWith('/uploads') ? `https://nexusfmsbackednshrikant-production.up.railway.app${viewingTenant.documentUrl}` : viewingTenant.documentUrl}
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-3">
              ...
              {viewingTenant.documentUrl && (
                <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                  ...
                  <a
                    href={viewingTenant.documentUrl.startsWith('/uploads') ? `https://nexusfmsbackednshrikant-production.up.railway.app${viewingTenant.documentUrl}` : viewingTenant.documentUrl}
                    target="_blank"
                    rel="noreferrer"
