                ...
                {availableSlots.length === 0 ? (
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-56 overflow-y-auto pr-1">
                    {availableSlots.map((slot, i) => {
                      const isEcoSlot = i === 0; // Simulate the first slot being an area match
                      ...
                      return (
                        <button
                          ...
                          className={`p-3 rounded-xl border text-left transition-all cursor-pointer relative overflow-hidden ${
                            isSelected
                              ...
                              : isEcoSlot 
                                ? 'bg-indigo-50 border-indigo-200 text-slate-800 hover:bg-indigo-100 font-medium' 
                        ...
                        >
                          ...
                          {isEcoSlot && (
                            <div className={`absolute top-0 right-0 px-1.5 py-0.5 text-[8px] font-black tracking-wider rounded-bl-lg ${isSelected ? 'bg-sky-400/20 text-sky-100' : 'bg-indigo-500/20 text-indigo-700'}`}>
                              📍 ECO-SLOT
                            </div>
                          )}
                        </button>
