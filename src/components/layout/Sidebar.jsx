...
import { maintenanceAdminNavItems, maintenanceStaffNavItems, officeTeamNavItems } from '../../navigation/maintenanceNavigation';
...
export default function Sidebar({ collapsed, role, mobileOpen, onCloseMobile }) {
  ...
  let navItems = maintenanceAdminNavItems;
  if (user?.roleKey === 'maintenance-staff') {
    navItems = maintenanceStaffNavItems;
  } else if (user?.roleKey === 'office-team') {
    navItems = officeTeamNavItems;
  }
